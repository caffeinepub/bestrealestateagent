...
export class Backend implements backendInterface {
    ...
    async getAllListings(): Promise<Array<Property>> {
        if (this.processError) {
            try {
    ...
    async getFeaturedListings(): Promise<Array<Property>> {
        if (this.processError) {
            try {
    ...
    async removeProperty(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProperty(arg0: bigint, arg1: Property): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProperty(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
